module.exports.addFeedbackQuestions = async (req,res)=>{
    try{
        ...
        // console.log(sql)
        await db.query(`INSERT INTO public.feedbacks(event_id,question) VALUES (${req.body.eventId},'${JSON.stringify(req.body.question)}')`)
        // console.log(data)
...
module.exports.addFeedbackAnswer = async (req,res)=>{
    try{
        ...
        await db.query(`INSERT INTO public.feedbacks_answers(feedback_id,user_id,answers) VALUES (${req.body.feedbackId},${req.body.userId},'${JSON.stringify(req.body.answers)}')`)
        // console.log(data)
...
module.exports.getFeedbackQuestions = async (req,res)=>{
    try{
        const {db} = req.app.locals
